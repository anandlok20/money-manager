...
const taxSchema = z.object({
  ...
  capitalGainsShortTerm: z.coerce.number().min(0),
  capitalGainsLongTerm: z.coerce.number().min(0),
  businessIncome: z.coerce.number(),
  otherIncome: z.coerce.number().min(0),
  exemptIncome: z.coerce.number().min(0),
  ...
  tdsPaid: z.coerce.number().min(0),
  advanceTaxPaid: z.coerce.number().min(0),
  selfAssessmentTax: z.coerce.number().min(0),
